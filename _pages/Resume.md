...
* **M.S. in Mechanical Engineering**, GPA: 3.8/4.0, Aug 2018 - Dec 2019
    * *Coursework:* Monitoring using Remote Sensing, Optimization Models and Methods

### **Ghulam Ishaq Khan Institute of Engineering Sciences and Technology**
* **B.S. in Mechanical Engineering**, GPA: 3.85/4.0, Aug 2014 - Jun 2018
...
* Developed KPIs to introduce accountability for the Shell-CBRE model resulting in a **bonus-malus of up to 35%**.
* Identified and analyzed projects with largest L3 margins to spot savings on CAPEX projects.
...
* Feature engineered spatio-temporal datasets for small-holder irrigation detection and crop classification.
* Optimized two level network design of electricity access using **MST** which saved \$2k in compute costs.

### **Data Driven Decision Modeling Projects** | Regression, A/B Testing (Aug 2024 - Dec 2024)
* Analyzed health insurance marketplace data using **logit model** to design a flat premium and maximize total by 12%.
* Investigated the effect of sending coupons to new and past customers on revenue of an online store using **A/B testing**.
* Studied the impact on sales revenue from different advertising mediums using a regression model.

### **Cloud Computing and Big Data Projects** | AWS, Natural Language Processing (Aug 2021 - Dec 2021)
* Developed a dining concierge chatbot using **AWS** that sends restaurant recommendations via text.
* Leveraged **Amazon SageMaker** for Spam Detection of email messages.
